...
app.post("/signup", async (req, res) => {
  try {
    ...
    res.json({ status: "error", message: "Bu foydalanuvchi nomi band yoki tizimda xatolik!" });
  }
});
...
app.post("/order", async (req, res) => {
  try {
    ...
    res.json({ status: "error", message: "Buyurtmani saqlashda xatolik: " + err.message });
  }
});

// ---------------- ORDERS LIST (haydovchi uchun)
app.get("/orders", async (req, res) => {
  try {
    ...
    res.json({ status: "error", message: "Buyurtmalarni olishda xatolik" });
  }
});
